    ...
    <main>
      {user && session?.user?.name === user.username && (
        <div className="text-white">
          ...
          <form
            className="m-12 p-8 bg-grey rounded-md"
              ...
              <div className="border-b border-white/10 pb-12">
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="col-span-full">
                    ...
                    <p className="mt-3 text-sm leading-6 text-gray-300">
                      Describe your role and any details you want to add here.
                    </p>
                  </div>
                ...
                <div className="mt-2 flex items-center gap-x-3">
                  ...
                  <div className="col-span-full">
                    ...
                    <label
                      htmlFor="file-upload"
                      className="mt-2 flex justify-center rounded-lg border border-dashed bg-black border-white/25 px-6 py-10"
                    >
                      <input
                        id="file-upload"
                        name="file-upload"
      ...
      {user && session?.user?.name != user.username && redirect("/")}
